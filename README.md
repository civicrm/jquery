...
You should read the original jQuery README (included below) for general information.
Additionally, the addendum (at the bottom) adds information about maintaining this fork.
